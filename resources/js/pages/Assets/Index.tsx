...
import { Search, X, FileText, Upload } from 'lucide-react';
...
export default function AssetsIndex({ assets, filters, filterOptions }: IndexProps) {
    ...
    const hasActiveFilters = searchQuery || selectedKondisi || selectedLokasi || selectedStatus;
    ...
    const renderPagination = () => {
        ...
        const pages = [];
        const maxVisible = 5;
        let startPage = Math.max(1, assets.current_page - Math.floor(maxVisible / 2));
        let endPage = Math.min(assets.last_page, startPage + maxVisible - 1);
            ...
            <div className="flex items-center justify-between">
                <div className="text-sm text-muted-foreground">
                    {assets.from && assets.to ? (
                        <>Menampilkan {assets.from} sampai {assets.to} dari {assets.total} aset</>
                    ) : (
                ...
                <Pagination>
                    <PaginationContent>
                        <PaginationItem>
                            <PaginationPrevious
                                onClick={() => handlePageChange(assets.current_page - 1)}
                                className={
                        ...
                        {endPage < assets.last_page && (
                            <>
                                ...
                                <PaginationItem>
                                    <PaginationLink
                                        onClick={() => handlePageChange(assets.last_page)}
                                        className="cursor-pointer"
                                    >
                                        {assets.last_page}
                                    </PaginationLink>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-y-auto p-4 md:p-6">
                ...
                <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Kelola aset barang milik negara</p>
                    </div>
                                ...
                                <SelectContent>
                                    ...
                                    {filterOptions.locations.map((location) => (
                                        <SelectItem key={location.id} value={location.id}>
                                            ...
                                            {location.gedung && ` - ${location.gedung}`}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                            </Select>
                ...
                {assets.data.length === 0 ? (
                    <div className="flex flex-col items-center justify-center rounded-lg border p-12 text-center">
                        ...
                        <h3 className="text-lg font-semibold">Tidak ada aset ditemukan</h3>
