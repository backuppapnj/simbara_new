...
export const MovingBorder: React.FC<MovingBorderProps> = ({
  ...
  return (
    <motion.div
      className={cn(
        'relative inline-flex h-full w-full overflow-hidden rounded-[var(--radius)] bg-transparent p-[1px] group',
        containerClassName
      )}
      style={
        {
    ...
    >
      ...
      <div
        className={cn(
          'relative inline-flex h-full w-full items-center justify-center rounded-[var(--radius)] bg-white dark:bg-neutral-950 backdrop-blur-xl',
          className
        )}
        style={
          {
