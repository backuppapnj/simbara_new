...
describe('MagicUI Components - Exports', () => {
    ...
    it('AnimatedButton renders and accepts all variants', () => {
        const { rerender } = render(
            <MagicComponents.AnimatedButton variant="primary">
                Primary
            </MagicComponents.AnimatedButton>,
        );
        expect(screen.getByRole('button')).toBeInTheDocument();

        rerender(
            <MagicComponents.AnimatedButton variant="secondary">
                Secondary
            </MagicComponents.AnimatedButton>,
        );
        rerender(
            <MagicComponents.AnimatedButton variant="shimmer">
                Shimmer
            </MagicComponents.AnimatedButton>,
        );
    });
    ...
    it('TypingAnimation renders with cursor', () => {
        const { container } = render(
            <MagicComponents.TypingAnimation text="Hello World" />,
        );
    ...
    it('MovingBorderButton renders interactive button', () => {
        render(
            <MagicComponents.MovingBorderButton>
                Moving Border
            </MagicComponents.MovingBorderButton>,
        );
        expect(screen.getByRole('button')).toBeInTheDocument();
