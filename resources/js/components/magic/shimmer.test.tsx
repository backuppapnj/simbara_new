...
import { Shimmer, ShimmerButton, ShimmerText } from '@/components/magic/shimmer';
...
describe('Shimmer Components', () => {
  ...
  describe('ShimmerButton', () => {
    ...
    it('passes through additional props', () => {
      render(<ShimmerButton data-testid="test-button">Test</ShimmerButton>);
  ...
  describe('ShimmerText', () => {
    ...
    it('applies custom className', () => {
      ...
      expect(screen.getByText('Text').parentElement).toHaveClass('text-xl');
    });
  });
});
