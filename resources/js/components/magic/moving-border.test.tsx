...
import { MovingBorder, MovingBorderButton } from '@/components/magic/moving-border';
...
describe('MovingBorder Components', () => {
  ...
  describe('MovingBorderButton', () => {
    ...
    it('passes through button props', () => {
      render(<MovingBorderButton type="submit">Submit</MovingBorderButton>);
      expect(screen.getByRole('button')).toHaveAttribute('type', 'submit');
    });

    it('applies custom className', () => {
      render(<MovingBorderButton className="custom-class">Button</MovingBorderButton>);
    ...
    it('handles click events', () => {
      let clicked = false;
      render(
        <MovingBorderButton onClick={() => (clicked = true)}>Click</MovingBorderButton>
      );
